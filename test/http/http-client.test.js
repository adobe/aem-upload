...
describe('HTTP Client Tests', function() {
    ...
    it('http request submit smoke test', async function() {
        MockRequest.onGet('http://myunittest.com').reply(200, 'hello world!');
        const response = await httpClient.submit(createHttpRequest('http://myunittest.com'));
    ...
    it('test submit retry', async function() {
        const url = 'http://myretryunittest';
    ...
    it('test submit retry all fail', async function() {
        const url = 'http://myfailingretryunittest';
    ...
    it('test submit retry not retryable error', async function() {
        const url = 'http://mynotfoundunittest';
    ...
    it('test cancel multiple requests', async function() {
        const url = 'http://multiplecancel';
        const url2 = 'http://multiplecancel2';
